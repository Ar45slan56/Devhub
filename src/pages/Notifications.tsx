        ...
        <div className=" bg-[var(--card-bg)] rounded-lg shadow-sm ">
          ...
          <div className="border-b dark:border-gray-700 p-4 text-[var(--accent)] ">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4 bg-[var(--card-bg)] ">
                <select
                  value={filter}
                  onChange={(e) =>
                    setFilter(e.target.value as 'all' | 'unread')
                  }
                  className="rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 border-[var(--border-color)] bg-[var(--card-bg)] "
                >
                ...
                <button
                  ...
                  className="text-sm hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300"
                >
                  Mark all as read
                </button>
              </div>
          ...
          <div className="divide-y  divide-gray-200 dark:divide-gray-700">
            {filteredNotifications.length === 0 ? (
              ...
              filteredNotifications.map((notification) => (
                <div
                  key={notification.id}
                  className={`p-4 hover:bg-[var(--bg-primary)]  dark:hover:bg-gray-700 transition-colors ${
                    !notification.read
                      ? 'bg-[var(--card-bg)]'
                      : ''
                  }`}
